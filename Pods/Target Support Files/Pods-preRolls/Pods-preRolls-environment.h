...
// SAMobileSDK
#define COCOAPODS_POD_AVAILABLE_SAMobileSDK
#define COCOAPODS_VERSION_MAJOR_SAMobileSDK 1
#define COCOAPODS_VERSION_MINOR_SAMobileSDK 1
#define COCOAPODS_VERSION_PATCH_SAMobileSDK 2
